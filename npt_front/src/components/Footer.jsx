...
function Footer() {
  const youtube = "https://www.youtube.com/channel/UCP0_SudzP9_KQQKsUXOJPRg";
  const facebook = "https://www.facebook.com/nephewpt";
  const instagram = "https://www.instagram.com/nephewpt/";
  const yelp = "https://www.yelp.com/biz/nephew-physical-therapy-holland";
  const height = 36;
  const width = 36;
