...
export const Executives = [
  {
    ...
    bio: "Emily Greenway is the driving force and visionary leader behind EcoGlow Innovations. A seasoned entrepreneur with a profound passion for sustainability and innovation, Emily brings a wealth of experience to her role. Her background in environmental science serves as the foundation for her commitment to creating eco-conscious solutions. With a notable track record of successful ventures in the realm of sustainability, Emily founded EcoGlow with the ambition of revolutionizing the lighting industry. Her unwavering dedication to fostering a greener future, combined with her strategic business acumen, has propelled the company to the forefront of sustainable lighting solutions. Emily envisions a world where cutting-edge technology and environmental responsibility coexist harmoniously, and she is steadfast in her commitment to steering EcoGlow Innovations towards that bright and sustainable future.",
  },
  {
    id: 2,
    firstName: "Alexander",
