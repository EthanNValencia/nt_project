...
const GoogleMapsButton = (props) => {
  ...
  return (
    <div>
      <button
        type="button"
        className={`${WebsiteColors.buttonColors} fill-white hover:fill-black inline-flex items-center px-8 py-2 font-semibold leading-6 text-sm shadow rounded-md first-line:transition ease-in-out duration-150 cursor-pointer`}
        disabled=""
      >
        <svg
