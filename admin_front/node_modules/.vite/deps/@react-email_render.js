...
var unicodeEscapedSequence_ = token((t) => t.name === "unicode" ? String.fromCodePoint(parseInt(t.text.slice(1), 16)) : void 0);
var escapedSequence_ = token((t) => t.name === "escape" ? t.text.slice(1) : void 0);
var anyChar_ = token((t) => t.name === "any" ? t.text : void 0);
...
var ProcessingInstruction2 = class extends DataNode {
...
var CDATA3 = class extends NodeWithChildren {
  constructor() {
    super(...arguments);
...
var DomHandler = class {
  ...
  onprocessinginstruction(name2, data) {
    const node = new ProcessingInstruction2(name2, data);
    this.addNode(node);
  }
...
function existsOne(test, nodes) {
  return nodes.some((checked) => isTag3(checked) && (test(checked) || existsOne(test, checked.children)));
}
...
var Checks = {
  tag_name(name2) {
    if (typeof name2 === "function") {
      return (elem) => isTag3(elem) && name2(elem.name);
    } else if (name2 === "*") {
      return isTag3;
    }
    return (elem) => isTag3(elem) && elem.name === name2;
  },
  tag_type(type) {
...
var renderAsync = (component, options) => __async(void 0, null, function* () {
  const reactDOMServer = (yield import("./server.browser-CQF764CY.js")).default;
